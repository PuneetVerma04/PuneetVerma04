...
Building applied ML systems — computer vision deployment and LLM/RAG pipelines — with a full-stack background in .NET, Java, and Angular/React. Looking for AI/ML engineer roles where I can take models from notebook to production.
...
| [Portfolio](https://github.com/PuneetVerma04/Portfolio) | Personal site | React, TypeScript, Tailwind CSS, Vite | live — puneetverma.tech |
...
**LLM/RAG:** LangGraph, Ollama, Qdrant
**Backend:** FastAPI, ASP.NET Core
**Frontend:** Angular, React, Tailwind CSS
**Infra:** Docker, MongoDB, SQL Server, Git
